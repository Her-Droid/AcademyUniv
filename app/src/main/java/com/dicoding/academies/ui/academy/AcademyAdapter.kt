...
class AcademyAdapter : RecyclerView.Adapter<AcademyAdapter.CourseViewHolder>() {
    ...
    class CourseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(course: CourseEntity) {
            with(itemView) {
                tv_item_title_academy.text = course.title
                tv_item_description_academy.text = course.description
                tv_item_date_academy.text = itemView.resources.getString(R.string.deadline_date, course.deadline)
